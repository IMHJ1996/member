...
//            memberDTOList.add(memberDTO);
    ...
    public MemberDTO findByMemberEmail(String memberEamail){
        MemberEntity memberEntity = memberRepository.findByMemberEmail(memberEamail).orElseThrow(() -> new NoSuchElementException());
        return MemberDTO.toDTO(memberEntity);
    }
